...
def colleges_func(event):
    global manage_text,add_college,view_college,add_canvas,view_canvas
...
def save_college():
    ...
    messagebox.showinfo("Success", f"College '{formatted_college}' added successfully!")
...
def add_college_function(event=None):
    ...
    if not is_form_visible: 
        ...
        frame.create_window(165, 30, window=manage_text)
        form_widgets.append(manage_text)
        ...
        frame.create_window(165, 170, window=save_canvas)
