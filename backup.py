...
def add_college_function(event=None):
    global course_code,course_name,save_canvas,save_button,save_text,manage_text
...
def view_college_function(event=None):
    ...
    if not is_form_visible: 
        ...
        style = ttk.Style()
        style.configure("Custom.Treeview", background="lightgray", foreground="black", rowheight=25, fieldbackground="lightgray")
        style.configure("Custom.Treeview.Heading", background="lightgray", foreground="black", font=("Arial", 10, "bold"), relief="flat")  
        ...
        college_table.heading("#3", text="Number of Programs")

        college_table.column("#1", width=150, anchor="w")
        college_table.column("#2", width=350, anchor="w")
        college_table.column("#3", width=150, anchor="center")
        ...
        frame.create_window(75, 290, window=edit_canvas)
        ...
        frame.create_window(175, 290, window=delete_canvas)
...
def add_program_function(event=None):
    global program_dropdown,program_code,program_name,manage_text2,save_canvas2,save_button2,save_text2
