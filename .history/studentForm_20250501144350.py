...
def create_form(root, body_frame=None, mode="add", student_data=None, refresh_callback=None):
    ...
    # Create a dictionary to map college names to their IDs and codes
    ...
    # Function to update programs when college is selected
# In the on_college_select function:
    def on_college_select(event):
        ...
        if selected_college != "Select":
            ...
            programs = get_programs_by_college(college_id, exclude_na=True)  # Add this parameter
            program_names = []
            program_dict.clear()
