...
def sort_function(body_frame):
    ...
    create_rounded_rectangle(sort_canvas, 0, 0, 250, 200, radius=20, fill="red", outline="#E4EBF5", width=2)
    ...
    sort_canvas.create_window(250/2, 230, window=sort_frame,width=250, height=280)
    sort_options = [
        ("ID Number", "id_number"),
        ("Name", "last_name"),
    ]
