...
def sort_function(body_frame):
    ...
    apply_bg = create_rounded_rectangle(button_canvas, 10, 5, 110, 45, radius=15, fill="#3A7FF6", outline="#3A7FF6")
    cancel_bg = create_rounded_rectangle(button_canvas, 120, 5, 220, 45, radius=15, fill="#f0f0f0", outline="#f0f0f0")
