...
def sort_function(body_frame):
    ...
    sort_frame = Frame(sort_canvas, bg="white", borderwidth=0, highlightthickness=0)
    ...
    button_frame = Canvas(sort_frame, bg="white", width=250, height=40, highlightthickness=0, borderwidth=0)
