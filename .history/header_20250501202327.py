...
def header(root):
    global search_frame, icon_label, text_label, search_var, cancel, search_bar,search_canvas
    ...
    search_canvas.create_window(10, 16, anchor="w", window=search_bar, width=530, height=25)
...
def resize_search_bar(event):
    ...
    create_rounded_rectangle(search_canvas, 2, 2, width-2, 30, radius=15,
