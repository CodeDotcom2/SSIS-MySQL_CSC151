...
def create_sort_button():
    ...
    # Create canvas
    sort_canvas = Canvas(top, width=35, height=30, highlightthickness=0, bd=0, bg="white")
    sort_canvas.grid(row=0, column=1, padx=(0, 70), pady=0, sticky="e")
    
    # Create rounded rectangle background
    sort_frame = create_rounded_rectangle(sort_canvas, 4, 20, 35, 30, radius=20, fill="white") 
