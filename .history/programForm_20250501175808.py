...
def add_program_form(root, body_frame=None, edit_mode=False, program_id=None, program_name=None, program_code=None, college_id=None):
    ...
    # If in edit mode and college_id is provided, set the dropdown to that college
    if edit_mode and college_id and college_id in college_id_to_option:
        college_dropdown.set(college_id_to_option[college_id])
    else:
