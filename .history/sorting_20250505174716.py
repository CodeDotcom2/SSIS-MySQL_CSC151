...
def sort_function(body_frame):
    ...
    apply_button = create_rounded_rectangle(button_frame, 5, 5, 118, 40, radius=20, fill="red", outline="#3A7FF6")

    close_button = create_rounded_rectangle(button_frame, 122, 5, 240, 40, radius=20, fill="violet", outline="#F0F0F0")    
