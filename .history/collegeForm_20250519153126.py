...
def view_colleges_form(root, body_frame=None):
    ...
    form_frame = Canvas(body_frame, bg="white", width=600, height=450, bd=0, highlightthickness=0)
    form = create_rounded_rectangle(form_frame, -300, 0, 600, 450, radius=130, fill='lightgray')
