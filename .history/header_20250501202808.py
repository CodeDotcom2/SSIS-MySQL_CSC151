...
def header(root):
    ...
    search_bar_window = search_canvas.create_window(10, 16, anchor="w", window=search_bar, width=500, height=25)
    ...
    def resize_search_bar(event):
        ...
        search_canvas.delete("rounded_bg")  # Remove old rounded rect
