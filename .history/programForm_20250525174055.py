...
from misc import create_rounded_rectangle,FormManager,bind_button_effects,on_select
...
def view_programs_form(root, body_frame=None):
    ...
    #program_search_bar.bind("<FocusIn>", clear_programs_entry)
    #program_search_bar.bind("<FocusOut>", program_restore)
    #icon4.bind("<Button-1>", clear_programs_entry)
    #icon5.bind("<Button-1>", clear_programs_entry)
