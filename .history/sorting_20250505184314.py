...
def sort_function(body_frame):
    ...
    sort_canvas.create_window(250/2, 170, window=sort_frame, width=230, height=250)
    ...
    # Create button canvas directly in sort_canvas (not in sort_frame)
    button_canvas = Canvas(sort_canvas, bg="white", width=230, height=50, highlightthickness=0)
    sort_canvas.create_window(250/2, 300, window=button_canvas)  # Centered in main canvas
    ...
    start_x = (230 - total_width) / 2  # Center in the 230px wide canvas
