...
def sort_function(body_frame):
    ...
    sort_frame = Frame(body_frame, bg="white", width=250, height=250, highlightthickness=0, borderwidth=0)
    sort_frame.place(relx=0.95, rely=0.0, anchor="ne")
    ...
    # Direction frame
    label_frame = Frame(sort_form, bg="white")
    ...
    direction_frame = Frame(sort_canvas, bg="white")
