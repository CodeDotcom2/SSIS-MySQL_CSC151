...
def header(root):
    ...
    search_field_combo.grid(row=0, column=2, padx=(120,0), pady=5)
    ...
    search_canvas.grid(row=0, column=1,columnspan=2, sticky="nsew", pady=5, padx=(0, 60))
    ...
    create_rounded_rectangle(search_canvas, 0, 0, 410, 30, radius=20, fill='#F1F3F8', outline="#E4EBF5", tag="rounded_bg")
