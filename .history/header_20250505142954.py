...
def header(root):
    ...
    search_canvas.search_bar_window = search_canvas.create_window(10, 16, anchor="w", window=search_bar, width=350, height=100)
    ...
    sort_button.grid(row=0, column=2, padx=(0, 80), pady=5)
