...
def header(root):
    ...
    # Sort button
    sort_frame = Frame(top, bg="red",width=30, height=30)
    sort_frame.grid(row=0, column=2, padx=(0, 10), pady=5, sticky="e")


    icon2 = PhotoImage(file="Images/Sort.png")
    sort_button = Button(sort_frame, image=icon2, bg="white", bd=0, cursor="hand2",
