...
def sort_function(body_frame):
    ...
    button_canvas.tag_bind(apply, "<Enter>", lambda e: button_canvas.itemconfig(apply, fill="#1A4A99"))
    ...
    button_canvas.tag_bind(cancel, "<Enter>", lambda e: button_canvas.itemconfig(cancel, fill="#AA4141"))
