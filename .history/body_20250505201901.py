...
def body(root):
    ...
    table_container.grid(row=0, column=0, sticky="nsew", padx=20, pady=(50, 20))  # 20px bottom padding
...
def setup_pagination():
    ...
    pagination_container.grid(row=1, column=0, sticky="ew", padx=20, pady=(0, 20))  # 0px top padding
