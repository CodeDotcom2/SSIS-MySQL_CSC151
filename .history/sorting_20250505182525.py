...
def sort_function(body_frame):
    ...
    sort_canvas = Canvas(body_frame, bg="#F0F0F0", width=250, height=300, highlightthickness=0, borderwidth=0)
    sort_canvas.place(relx=0.95, rely=0.0, anchor="ne")
    is_visible = True
    ...
    # Create background
    create_rounded_rectangle(sort_canvas, 0, 0, 250, 300, radius=20, fill="white", outline="#E4EBF5", width=2)
    ...
    sort_canvas.create_window(250/2, 170, window=sort_frame, width=230, height=200)
    ...
    button_frame.grid(row=len(sort_options)+1, column=0, sticky=E, pady=(15, 5), padx=20)
