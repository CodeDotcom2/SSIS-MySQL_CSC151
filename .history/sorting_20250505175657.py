...
def sort_function(body_frame):
    ...
    sort_canvas = Canvas(body_frame, bg="blue", width=250, height=300, highlightthickness=0, borderwidth=0)
    ...
    create_rounded_rectangle(sort_canvas, 0, 0, 250, 300, radius=20, fill="red", outline="#E4EBF5", width=2)

    sort_canvas.create_text(250/2, 30, text="Sort Students By", font=("Albert Sans", 15, "bold"), fill="#333333")

    sort_frame = Frame(sort_canvas, bg="violet", borderwidth=0, highlightthickness=0)
    sort_canvas.create_window(250/2, 230, window=sort_frame,width=250, height=240)
    sort_options = [
        ("ID Number", "id_number"),
        ("Name", "last_name"),
    ]
    ...
    button_frame = Canvas(sort_frame, bg="white", width=250, height=50, highlightthickness=0, borderwidth=0)
