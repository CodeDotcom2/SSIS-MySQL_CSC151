...
def view_programs_form(root, body_frame=None):
    ...
    def edit_selected():
        ...
        college_id = item_values[4]  # This should be the correct index for college_id
        
        # Debug print to verify values
        print(f"Editing Program - ID: {program_id}, Name: {program_name}, College ID: {college_id}")
    ...
    # Create the edit button (unchanged from your working version)
