...
def sort_function(body_frame):
    ...
    sort_canvas.create_text(100, 30, text="Sort Students By", font=("Albert Sans", 15, "bold"), fill="#333333")

    sort_frame = Frame(sort_canvas, bg="red", bd=0, highlightthickness=0)
    sort_canvas.create_window(125, 200, window=sort_frame)
