...
from misc import create_rounded_rectangle,FormManager,bind_button_effects,on_select,remove_focus,set_root
    ...
    def submit_form():
        ...
        if edit_mode:
            ...
            if success:
                ...
                class DummyEvent:
                    def __init__(self):
                        self.widget = root  # assuming 'root' is your main window
                        
                remove_focus(DummyEvent())
