...
def view_colleges_form(root, body_frame=None):
    ...
    search_canvas = Canvas(body_frame, width=300, height=33, bg="lightgray", highlightthickness=0)
    body_frame.create_window(162, 75, window=search_canvas) 
        
    college_search_bar = Entry(body_frame, textvariable=colleges_var, bg="white", font=('Albert Sans', 12, 'normal'), fg="gray", borderwidth=0, highlightthickness=0)
    ...
    cancel_butts = Button(college_search_bar,image=cancel,bg="white",activebackground= "white", bd=0,cursor="hand2",command=clear_search)
