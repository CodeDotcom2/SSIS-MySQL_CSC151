...
def header(root):
    ...
    # Sort button
    sort_canvas = Canvas(top, bg="white",width=35, height=35,borderwidth=0, highlightthickness=0)
    sort_canvas.grid(row=0, column=3, padx=(0, 50), pady=2, sticky="e")

    sort = create_rounded_rectangle(sort_canvas,4, 7, 35, 35,radius=20, fill="white")
    ...
    def on_sort_hover(event):
        sort_canvas.itemconfig(sort,bg="#E4EBF5")
    def on_sort_leave(event):
        sort_canvas.itemconfig(sort,bg="white")
