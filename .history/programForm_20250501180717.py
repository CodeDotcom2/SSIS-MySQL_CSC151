...
def add_program_form(root, body_frame=None, edit_mode=False, program_id=None, program_name=None, program_code=None, college_id=None):
    ...
    college_options = []
    college_ids = {}
    selected_college_display = ""  # This will store the display text for the selected college
    ...
    for college in colleges:
        ...
        # If we're in edit mode and this college matches the program's college_id
...
def view_programs_form(root, body_frame=None):
    ...
    def edit_selected():
        ...
        college_id = int(item_values[4])  # Convert to integer here
