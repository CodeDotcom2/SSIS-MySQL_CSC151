...
student_table = None
current_page = 0
items_per_page = 20  # Initial value, will be updated dynamically
total_pages = 1
selected_student_id = None
body_frame = None
table_frame = None
last_table_height = 0  # To track when we need to recalculate
...
def body(root):
    ...
    table_frame.bind("<Configure>", lambda e: handle_resize())
...
def calculate_rows_per_page():
    ...
    # Estimate based on actual row height and available space
    row_height = 40  # Should match your rowheight in the style
    ...
    return min(max_rows, 20)  # Cap at 20 rows to prevent too many
...
def display_students(page=0):
    ...
    students, total_count = get_all_students(
        page=page + 1,  # Assuming your API is 1-based
