...
def header(root):
    ...
    radius = 15
    create_rounded_rectangle(search_canvas, 2, 2, 550, 30, radius=radius, fill='#E4EBF5', outline="#E4EBF5")

    # Place the entry widget on the canvas
    search_bar = Entry(search_canvas, textvariable=search_var, bg="red", 
                     font=('Albert Sans', 10, 'normal'), fg="gray", 
                     borderwidth=0, highlightthickness=0)
    search_canvas.create_window(10, 16, anchor="w", window=search_bar, width=500, height=25)
