...
def sort_function(body_frame):
    global header_components, is_visible

    # Initialize header if not done yet
    if header_components is None:
        header_components = header(root)
    
    sort = header_components['sort']
    sort_canvas = header_components['sort_canvas']
