...
def sort_function(body_frame):
    ...
    sort_canvas = Canvas(body_frame, bg="red", width=250, height=200, highlightthickness=0, borderwidth=0)
    ...
    create_rounded_rectangle(sort_canvas, 0, 0, 250, 200, radius=20, fill="white", outline="#E4EBF5", width=2)
