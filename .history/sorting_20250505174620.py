...
def sort_function(body_frame):
    ...
    apply_button = create_rounded_rectangle(button_frame, 5, 5, 110, 40, radius=20, fill="red", outline="#3A7FF6")

    close_button = create_rounded_rectangle(button_frame, 110, 5, 230, 40, radius=20, fill="blue", outline="#F0F0F0")    
