...
def sort_function(body_frame):
    ...
    button_frame = Canvas(sort_frame, bg="white")
    button_frame.grid(row=len(sort_options)+2, column=0, sticky=E, pady=20, padx=20)

    apply_button = create_rounded_rectangle(button_frame, 0, 0, 100, 30, radius=20, fill="#3A7FF6", outline="#3A7FF6")
    sort_canvas.create_window(0, 0, window=apply_button, anchor="nw")
#
