...
def sort_function(body_frame):
    ...
    sort_canvas = Canvas(body_frame, bg="#E8E8E8", width=250, height=265, highlightthickness=0, borderwidth=0)
    sort_canvas.place(relx=0.95, rely=0.0, anchor="ne")
    is_visible = True
    ...
    # Create background
    create_rounded_rectangle(sort_canvas, 0, 0, 250, 265, radius=20, fill="white", outline="#E4EBF5", width=2)
