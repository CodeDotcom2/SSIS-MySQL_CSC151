...
def sort_function(body_frame):
    ...
    sort_canvas = Canvas(body_frame, bg="blue", width=250, height=400, highlightthickness=0, borderwidth=0)
    ...
    sort_canvas.create_window(250/2, 230, window=sort_frame,width=250, height=200)
    sort_options = [
        ("ID Number", "id_number"),
        ("Name", "last_name"),
    ]
