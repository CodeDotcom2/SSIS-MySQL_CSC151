...
def sort_function(body_frame):
    ...
    # Create background
    create_rounded_rectangle(sort_canvas, 0, 0, 250, 265, radius=20, fill="#E8E8E8", outline="#E4EBF5", width=2)
    ...
    sort_frame = Frame(sort_canvas, bg="#E0E0E0", bd=0, highlightthickness=0)
