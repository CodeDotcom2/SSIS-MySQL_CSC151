...
def sort_function(body_frame):
    ...
    apply_button = create_rounded_rectangle(button_frame, 5, 5, 125, 40, radius=20, fill="red", outline="#3A7FF6")

    close_button = create_rounded_rectangle(button_frame, 130, 5, 250, 40, radius=20, fill="#F0F0F0", outline="#F0F0F0")    
