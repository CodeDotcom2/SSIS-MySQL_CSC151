...
def create_sort_button():
    ...
    # Create canvas
    sort_canvas = Canvas(top, width=35, height=30, highlightthickness=0, bd=0, bg="red")
    sort_canvas.grid(row=0, column=1, padx=(0, 68), pady=0, sticky="e")
    
    # Create rounded rectangle background
    sort_frame = create_rounded_rectangle(sort_canvas, 4, 0, 35, 30, radius=20, fill="white") 
    
    # Load the image
    sort_img = PhotoImage(file="Images/sort.png")
    sort_canvas.create_image(20, 15, image=sort_img, anchor="center") 
