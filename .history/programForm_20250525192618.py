    ...
    def submit_form():
        ...
        if edit_mode:
            ...
            if success:
                ...
                college_dropdown.configure(style="Gray.TCombobox")
                college_dropdown.set("Select College")  # Ensure the display text is set
                
                # Force a complete refresh of the dropdown styling
                college_dropdown.state(['readonly'])  # Reset state
                college_dropdown.update()  # Force update
